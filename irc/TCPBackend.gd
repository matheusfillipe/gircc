# TODO copy done simple tcp client from here: https://www.bytesnsprites.com/posts/2021/creating-a-tcp-client-in-godot/ "The final client looks like the following."
